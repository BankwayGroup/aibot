...
strings: [
  ...
  '1 tab to rule them all, 2 spaces to divide them.',
  'Ships in port are safe, but that’s not what ships are for — Grace Hopper',
  'Object Oriented Programming: You wanted bananas but got the gorilla holding the banana and the jungle.',
  '640K ought to be enough for anybody. — Bill Gates (probably not)',
